...
export class VendaComponent implements OnInit {
  ...
  trackId = (item: IVenda): number => this.vendaService.getVendaIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.vendas().length === 0) {
            ...
            this.vendas.set(this.refineData(this.vendas()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.vendas.set(this.refineData(dataFromBody));
  }

  protected refineData(data: IVenda[]): IVenda[] {
