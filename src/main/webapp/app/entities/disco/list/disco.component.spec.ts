...
import { sampleWithRequiredData } from '../disco.test-samples';
...
describe('Disco Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.discos()[0]).toEqual(expect.objectContaining({ id: 9789 }));
  });

  describe('trackId', () => {
    it('should forward to discoService', () => {
      const entity = { id: 9789 };
      jest.spyOn(service, 'getDiscoIdentifier');
      const id = comp.trackId(entity);
      expect(service.getDiscoIdentifier).toHaveBeenCalledWith(entity);
