...
export class LivroComponent implements OnInit {
  ...
  trackId = (item: ILivro): number => this.livroService.getLivroIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.livros().length === 0) {
            ...
            this.livros.set(this.refineData(this.livros()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.livros.set(this.refineData(dataFromBody));
  }
